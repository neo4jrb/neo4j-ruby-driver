...
module Bolt
  module Dictionary
    ...
    attach_function :value, :BoltDictionary_value, %i[pointer int32_t], :pointer
    attach_function :value_by_key, :BoltDictionary_value_by_key, %i[pointer string int32_t], :pointer
  end
end
