module Bolt
  module Connection
    ...
    attach_function :set_run_cypher, :BoltConnection_set_run_cypher, [:pointer, :string, :uint64_t, :int32_t], :int32_t
    attach_function :set_run_cypher_parameter, :BoltConnection_set_run_cypher_parameter,
                    [:pointer, :int32_t, :string, :uint64_t], :pointer
    attach_function :load_run_request, :BoltConnection_load_run_request, [:pointer], :int32_t
    attach_function :load_discard_request, :BoltConnection_load_discard_request, [:pointer, :int32_t], :int32_t
    attach_function :load_pull_request, :BoltConnection_load_pull_request, [:pointer, :int32_t], :int32_t
    ...
    attach_function :fetch, :BoltConnection_fetch, [:pointer, :bolt_request], :int32_t
    attach_function :fetch_summary, :BoltConnection_fetch_summary, [:pointer, :bolt_request], :int32_t
