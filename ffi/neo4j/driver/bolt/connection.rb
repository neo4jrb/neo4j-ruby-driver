...
module Bolt
  module Connection
    ...
    attach_function :flush, :BoltConnection_send, [:pointer], :int32_t
    ...
    attach_function :clear_begin, :BoltConnection_clear_begin, %i[pointer], :int32_t
    attach_function :set_begin_bookmarks, :BoltConnection_set_begin_bookmarks, %i[pointer pointer], :int32_t
    attach_function :set_begin_tx_timeout, :BoltConnection_set_begin_tx_timeout, %i[pointer int64_t], :int32_t
    attach_function :set_begin_tx_metadata, :BoltConnection_set_begin_tx_metadata, %i[pointer pointer], :int32_t
    attach_function :load_begin_request, :BoltConnection_load_begin_request, %i[pointer], :int32_t
    attach_function :load_commit_request, :BoltConnection_load_commit_request, %i[pointer], :int32_t
    attach_function :load_rollback_request, :BoltConnection_load_rollback_request, %i[pointer], :int32_t
    attach_function :clear_run, :BoltConnection_clear_run, %i[pointer], :int32_t
    attach_function :set_run_bookmarks, :BoltConnection_set_run_bookmarks, %i[pointer pointer], :int32_t
    attach_function :set_run_tx_timeout, :BoltConnection_set_run_tx_timeout, %i[pointer int64_t], :int32_t
    attach_function :set_run_tx_metadata, :BoltConnection_set_run_tx_metadata, %i[pointer pointer], :int32_t
