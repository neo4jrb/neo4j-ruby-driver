  ...
  module Conversion
    def to_testkit(object)
      ...
      when Neo4j::Driver::Types::OffsetTime
        named_entity('CypherTime', hour: object.hour, minute: object.minute, second: object.second,
                                   nanosecond: object.nanosecond, 'utc_offset_s' => object.tz_offset_seconds)
      ...
      when Time
        ...
        named_entity('CypherDateTime', **map_of(object, :year, :month, :day, :hour), minute: object.min,
                                                                                     second: object.sec, nanosecond: object.nsec, 'utc_offset_s' => object.utc_offset, 'timezone_id' => object.zone.try(:identifier) || object.try(:time_zone)&.name)
      when Symbol
